...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val game3 = Game(
            "Disco Elysium",
            arrayListOf("RPG", "Indie", "Detective"),
            39.99,
        ...
        val game4 = Game(
            "Stardew Valley",
            arrayListOf("Farming", "Indie", "Simulation"),
            14.99,
            "https://assets.nintendo.com/image/upload/c_fill,w_1200/q_auto:best/f_auto/dpr_2.0" +
        ...
        val game5 = Game(
            "Opus Magnum",
            arrayListOf("Puzzle", "Indie", "Programming"),
            19.99,
